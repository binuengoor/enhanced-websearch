...
| MP-09 Optional product enhancements | todo | not started | not started | scope tightened to optional local-first polish only: report export, minimal recent-run history, tiny diagnostics surface, and file-based persistence only if clearly needed |
